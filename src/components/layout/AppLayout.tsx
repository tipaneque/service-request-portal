 ...
 * light tile instead of being recoloured, preserving the original artwork.
 */
        ...
        >
          <Box
            ...
            sx={{
              ...
              height: 20,
              objectFit: "contain",
              // The artwork is pale grey, so darken it against the light surface.
...
/**
 * Chrome shared by every authenticated screen: skip link, header and the
